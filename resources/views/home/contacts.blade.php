...
<br><br><br>
	<main>
		<div class="hero_single inner_pages background-image" data-background="url({{ asset('public/home_assets/img/home_section_2.jpg')}})">
			<div class="opacity-mask" data-opacity-mask="rgba(0, 0, 0, 0.6)">
				<div class="container">
					<div class="row justify-content-center">
						<div class="col-xl-9 col-lg-10 col-md-8">
							<h1>Contact Foodie Moodie</h1>
		        ...
		        <div class="row justify-content-center">
		            <div class="col-lg-4">
		                <div class="box_contacts">
		                    ...
		                    <h2>Help Center</h2>
		                    <a href="contacts.html#0">+94 423-23-221</a> - <a href="contacts.html#0">help@fooyes.com</a>
		            ...
		            <div class="col-lg-4">
		                <div class="box_contacts">
		                    ...
		                    <h2>Submissions</h2>
		                    <a href="contacts.html#0">+94 423-23-221</a> - <a href="contacts.html#0">order@fooyes.com</a>
		                    <small>MON to FRI 9am-6pm SAT 9am-2pm</small>
		                </div>
		            </div>
		        </div>
		    ...
		    <div class="row">
		        <div class="col-lg-4 col-md-6 add_bottom_25">
		            <div id="message-contact"></div>
			            <form method="post" action="https://foodiemoodie.junaidali.tk/contact.php" id="contactform" autocomplete="off">
