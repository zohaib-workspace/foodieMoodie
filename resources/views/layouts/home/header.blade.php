...
<header class="header black_nav clearfix element_to_stick">
    <div class="container">
        ...
        <nav class="main-menu">
            ...
            <ul>
                <li class="submenu">
                    <p class="show-submenu badge bg-orange py-2"> <i class="fa-solid fa-location-dot"></i> {{session()->get('searched_name')}}</p>
                </li>
                <li class="submenu">
                ...
                <li><a href="{{ route('user.notifications.index') }}"><i class="fa-regular fa-bell"></i></a></li>
                @php
