                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                 ...
                                 @php($whatsapp_no = \App\Models\BusinessSetting::where('key', 'whatsapp_no')->first())
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="input-label"
                                            for="exampleFormControlInput1">{{ translate('messages.whatsapp_no') }}</label>
                                        <input type="number" value="{{ $whatsapp_no->value ?? '' }}" name="whatsapp_no"
                                            class="form-control" placeholder="{{ translate('messages.Ex :') }} +9XXX-XXX-XXXX" required>
                                    </div>
                                </div>
