            ...
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title"><i class="tio-add-circle-outlined"></i> {{ translate('messages.add') }}
                        {{ translate('messages.new') }} {{ translate('messages.About') }}</h1>
                </div>
            </div>
        </div>
        <!-- End Page Header -->
                                        ...
                                        <div id="{{ $default_lang }}-form">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name" class="form-control"
                                                    placeholder="{{ translate('messages.about us') }}" required>
                                            </div>
            ...
            $.post({
                ...
                success: function(data) {
                    ...
                    if (data.errors) {
                        ...
                        toastr.success('{{ translate('messages.about_added_successfully') }}', {
                            CloseButton: true,
                            ProgressBar: true
                        });
                        setTimeout(function() {
                            location.href =
                                '{{ \Request::server('HTTP_REFERER') ?? route('admin.about.list') }}';
                        }, 2000);
                    }
                }
            });
