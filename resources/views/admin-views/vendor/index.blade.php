...
@section('title', translate('messages.Add_New_Vendor'))
            ...
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title"><i class="tio-shop-outlined"></i>
                        ...
                        {{ translate('messages.new') }} {{ translate('messages.vendor') }}</h1>
                </div>
            </div>
        </div>
        <!-- End Page Header -->
        ...
        <form action="{{ route('admin.vendor.store') }}" method="post" enctype="multipart/form-data"
            ...
            <div class="card mb-2">
                <div class="card-header">
                    <h4 class="card-title m-0 d-flex align-items-center"><img class="mr-2 align-self-start" src={{asset('public/assets/admin/img/resturent.png')}} alt="instructions"> <span>{{ translate('messages.vendor') }} {{ translate('messages.info') }}</span></h4>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6 col-xl-4">
                            <div class="form-group">
                                <label class="input-label" for="name">{{ translate('messages.vendor') }}
                        ...
                        <div class="col-md-6 col-xl-4">
                            <div class="form-group">
                            <label class="input-label" for="choice_business">{{ translate('messages.Business Type') }}
                                        <span data-toggle="tooltip" data-placement="right"
                                        class="input-label-secondary"><img
                                            src="{{ asset('/public/assets/admin/img/info-circle.svg') }}"
                                            alt="{{ translate('messages.restaurant_lat_lng_warning') }}"></span>
                                        </label>                               
                                        <select name="business_type" id="choice_business" required class="form-control h--45px js-select2-custom"
                                    data-placeholder="{{ translate('messages.select') }} {{ translate('messages.Business Type') }}"> 
                                    <!--<option value="" selected disabled>{{ translate('messages.Select Business Type') }}</option> -->                              
                                    <option value=1>Restaurant</option>
                                    @foreach (\App\Models\BusinessType::all() as $b_type)                                     
                                            <!--<option value="{{ $b_type->id }}">{{ $b_type->type }}</option>                               -->
                                    @endforeach
                                </select>
                            </div>
                        </div>
