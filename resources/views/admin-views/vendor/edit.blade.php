...
@section('title', translate('Update Vendor info'))
                    ...
                    <div class="card mb-3">
                        <div class="card-header">
                            <h5 class="card-title">
                                <div class="card-header-icon">
                                    <i class="tio-museum"></i> {{ translate('messages.Vendor') }}
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-6 col-lg-4 col-12">
                                    <div class="form-group">
                                    <label class="input-label" for="choice_types">{{ translate('messages.Business Type') }}<span
                                                class="input-label-secondary"
                                                title="{{ translate('messages.select_business_types') }}"><img
                                                    src="{{ asset('/public/assets/admin/img/info-circle.svg') }}"
                                                    alt="{{ translate('messages.select_business_type') }}"></span></label>
                                        <select name="business_type" id="choice_types" 
                                            ...
                                            <!--@foreach (\App\Models\BusinessType::all() as $b_type)
                                                    <option value="{{ $b_type->id }}"
                                                        {{ $restaurant->business_type == $b_type->id ? 'selected' : '' }}>
                                                        {{ $b_type->type }}</option>
                                            @endforeach-->
                                        </select>
                                    </div>
