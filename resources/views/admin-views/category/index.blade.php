        ...
        <div class="card mt-3">
            <div class="card-header py-2">
                ...
                <div class="input--group input-group input-group-merge input-group-flush">
                    <select name="business_type" id="business_type" class="form-control js-select2-custom" onchange="onTypeChange()">
                        <option value="all">{{translate('All_Business_Type')}}</option>
                        @foreach(\App\Models\BusinessType::orderBy('id')->get() as $b_type)
                        <option value="{{$b_type['id']}}" {{$params['business_type'] == $b_type['id']?'selected':''}}>
                            {{$b_type['type']}}s
                        </option>
                        @endforeach
                    </select>
