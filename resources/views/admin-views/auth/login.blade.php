...
<head>
    ...
    @endphp
    <!-- Title -->
    <title>{{ translate('messages.admin_login') }} | {{$app_name??translate('Absher')}}</title>
...
<main id="content" role="main" class="main auth-bg">
    ...
    <div class="d-flex flex-wrap align-items-center justify-content-between">
        <div class="auth-content">
            <div class="content">
                <h2 class="title text-uppercase">{{translate('messages.welcome_to_app',['app_name'=>$app_name??'Absher'])}}</h2>
                <p>
                    {{translate('Get the Food, Groceries and Goods you need, at your doorstep')}}
                </p>
            </div>
        </div>
                ...
                <div class="text-center">
                    <div class="auth-header mb-5">
                        ...
                        <p class="text-capitalize">{{ translate('Want To Login Your Restaurants') }}?
                            <a href="{{route('vendor.auth.login')}}" class="text-purple">
