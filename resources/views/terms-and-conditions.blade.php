...
@Section('main_content')
    ...
    <main class="bg_gray">
        ...
        <div class="container margin_60_40">
            ...
            <p>Welcome to Foodie Modie!</p>

            <p>These terms and conditions outline the rules and regulations for the use of Foodie Moodie's Website, located
                at https://foodie.junaidali.tk/user.</p>

            <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use Foodie
                Modie if you do not agree to take all of the terms and conditions stated on this page.</p>
            ...
            <p>The following terminology applies to these Terms and Conditions, Privacy Statement and Disclaimer Notice and
                ...
                of the Company's stated services, in accordance with and subject to, prevailing law of pk. Any use of the
            ...
            <p>We employ the use of cookies. By accessing Foodie Modie, you agreed to use cookies in agreement with the
                Foodie Moodie's Privacy Policy. </p>
            ...
            <p>Unless otherwise stated, Foodie Moodie and/or its licensors own the intellectual property rights for all
                material on Foodie Modie. All intellectual property rights are reserved. You may access this from Foodie
                Modie for your own personal use subjected to restrictions set in these terms and conditions.</p>

            <p>You must not:</p>
            <ul>
                <li>Republish material from Foodie Modie</li>
                <li>Sell, rent or sub-license material from Foodie Modie</li>
                <li>Reproduce, duplicate or copy material from Foodie Modie</li>
                <li>Redistribute content from Foodie Modie</li>
            </ul>



            <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in certain
                areas of the website. Foodie Moodie does not filter, edit, publish or review Comments prior to their
                presence on the website. Comments do not reflect the views and opinions of Foodie Moodie,its agents and/or
                affiliates. Comments reflect the views and opinions of the person who post their views and opinions. To the
                extent permitted by applicable laws, Foodie Moodie shall not be liable for the Comments or for any
            ...
            <p>Foodie Moodie reserves the right to monitor all Comments and to remove any Comments which can be considered
            ...
            <p>You hereby grant Foodie Moodie a non-exclusive license to use, reproduce, edit and authorize others to use,
            ...
            <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us look
                ...
                Foodie Moodie; and (d) the link is in the context of general resource information.</p>
            ...
            <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website,
                you must inform us by sending an e-mail to Foodie Moodie. Please include your name, your organization name,
            ...
            <p>No use of Foodie Moodie's logo or other artwork will be allowed for linking absent a trademark license
                agreement.</p>
