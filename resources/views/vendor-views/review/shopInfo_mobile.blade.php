...
{{-- @section('title',translate('messages.Business_view')) --}}
@section('content')
...
<div class="content container-fluid">
        ...
        <div class="d-flex flex-wrap justify-content-between">
            <h2 class="page-header-title text-capitalize my-2">
                <div>
                    ...
                    <span>
                        {{translate('messages.my_Business')}} {{translate('messages.info')}}
                    </span>
                </div>
            ...
            <div class="my-2">
                ...
                {{-- <a class="btn btn--primary" href="{{route('business-edit-mobile')}}"><i class="tio-edit"></i> {{translate('Edit Business Info')}}</a> --}}
                <a class="btn btn--primary" href="{{route('business-edit-mobile', ['rid' => $shop->id])}}"><i class="tio-edit"></i> {{translate('Edit Business Info')}}</a>
            </div>
        </div>
    </div>
    <!-- End Page Header -->
    <div class="card border-0">
        <div class="card-body p-0">
            @if($shop->cover_photo)
                <div>
                    <img src="{{asset('/public/storage/app/public/restaurant/cover/'.$shop->cover_photo)}}" onerror="this.src='{{asset('/public/assets/admin/img/900x400/img1.jpg')}}'" class="initial-93">
                </div>
            @endif
            <div class="my-resturant--card">
                ...
                @else
                    ...
                    <div class="my-resturant--avatar">
                        <img src="{{asset('/public/storage/app/public/restaurant/'.$shop->logo)}}" class="border"
