...
<head>
    ...
    @endphp
    <!-- Title -->
    <title>{{ translate('messages.Business Login') }} | {{$app_name??translate('STACKFOOD')}}</title>
    ...
    <div class="d-flex flex-wrap align-items-center justify-content-between">
        <div class="auth-content">
            <div class="content">
                ...
                <p>
                    {{translate('Manage your Business Portal easily')}}
                </p>
            </div>
        </div>
            ...
            <div class="auth-wrapper-body">
                ...
                <div class="text-center">
                    <div class="auth-header mb-5">
                        <h2 class="signin-txt">{{translate('messages.Business')}} {{translate('messages.sign_in')}}</h2>
                        <p class="text-capitalize">{{translate('messages.want_to_login_as_admin')}}
                            <a href="{{route('admin.auth.login')}}" class="text-purple">
                ...
                <form class="login_form initial-hidden" action="{{route('vendor.auth.login')}}" method="post" id="vendor_login_form">
                    ...
                    <div class="toggle-login">
                        {{ translate('Login as Business Employee') }}?  <span class="toggle-login-btn text-purple" data-type="emloyee" target-login="{{translate('messages.Business')}} {{translate('employee')}} {{translate('messages.sign_in')}}">{{ translate('messages.login_here') }}</span>
                    </div>
                ...
                <form class="login_form initial-hidden" action="{{route('vendor.auth.employee.login')}}" method="post" id="employee_login_form">
                    ...
                    <div class="toggle-login">
                        {{ translate('Login as Business Owner?') }}  <span class="toggle-login-btn text-purple" data-type="restaurant" target-login="{{translate('messages.Business')}} {{translate('owner')}} {{translate('messages.sign_in')}}">{{ translate('messages.login_here') }}</span>
                    </div>
...
<script>
    ...
    $('#owner_sign_in').on('click', function(){
        ...
        $('.signin-txt').text("{{translate('messages.Business')}} {{translate('owner')}} {{translate('messages.sign_in')}}")
    });
    $('#employee_sign_in').on('click', function(){
        ...
        $('.auth-wrapper-body-inner ').hide();
        $('.auth-wrapper-body').addClass('auth-form-appear');
        $('.signin-txt').text("{{translate('messages.Business')}} {{translate('employee')}} {{translate('messages.sign_in')}}")
    });
