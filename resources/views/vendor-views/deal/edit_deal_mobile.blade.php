...
@section('content')
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <h1 class="page-header-title"><i class="tio-add-circle-outlined"></i> {{ translate('create') }}
                {{ translate('messages.update') }} {{ translate('deal') }}</h1>
        </div>
        <!-- End Page Header -->
                                    ...
                                    <div class="{{ $lang != $default_lang ? 'd-none' : '' }} lang_form"
                                        ...
                                        <div class="form-group mb-0">
                                            ...
                                            <input type="text" {{ $lang == $default_lang ? 'required' : '' }}
                                                name="name[]" id="{{ $lang }}_name" class="form-control h--45px"
                                                placeholder="{{ translate('Ex : Update Food') }}"
                                                value="{{ $deal['title'] }}"
                                        ...
                                        <div class="form-group mb-0 ">
                                            ...
                                            <input type="number" min="0" max="100000" step="0.01"
                                                value="{{ $deal['price'] }}" name="price" class="form-control h--45px"
                                                placeholder="{{ translate('Ex : 100') }}" value="{{ $deal['price'] }}"
                                                required>
                                        </div>
                                        ...
                                        <div class="form-group pt-4 mb-0">
                                            ...
                                            <textarea type="text" name="description[]" class="form-control ckeditor min-height-154px"
                                                placeholder="{{ translate('Ex : Description') }}">{{ $deal['description'] }}</textarea>
                                        </div>
                                    </div>
                                @endforeach
                            @else
                                <div id="{{ $default_lang }}-form">
                                    <div class="form-group mb-0">
                                        ...
                                        <input type="text" name="name[]" class="form-control h--45px"
                                            placeholder="{{ translate('Ex : Sepcial Deal') }}"
                                    ...
                                    <div class="form-group pt-4 mb-0">
                                        ...
                                        <textarea type="text" name="description[]" class="form-contro ckeditor min-height-154px"
                                            placeholder="{{ translate('Ex : Description') }}" value="{{ $deal['description'] }}"></textarea>
                                    </div>
                                </div>
                            @endif
                        </div>
                    ...
                    <div class="card h-100">
                        <div class="card-header">
                            <h5 class="card-title">
                                ...
                                <span>{{ translate('Deal Image') }} <small
                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            <center id="image-viewer-section" class="py-3 my-auto">
                                <img class="initial-87" id="viewer"
                                    src="{{ asset('storage/app/public/product') }}/{{ $deal['image'] }}"
                        ...
                        @else
                            <center id="image-viewer-section" class="my-auto">
                                <img class="initial-88" id="viewer"
                        ...
                        <div class="card-body">
                            ...
                            <div class="row g-2">
                                <div class="col-md-4 col-sm-6">
                                    <div class="form-group mb-0">
                                        <label class="form-label"
                                            for="exampleFormControlSelect1">{{ translate('Items') }}<span
                                                class="input-label-secondary">*</span></label>
                                                <select name="item_id" id="item_id"
                                                class="form-control h--45px js-select2-custom"
                                                onchange="getRequest('{{ url('/') }}/get_variants_mobile?parent_id=' + this.value, 'variant_type')">
                                                <option value="" selected disabled>
                                                    ---{{ translate('messages.Select Item') }}---</option>
                                ...
                                <div class="col-md-4 col-sm-6">
                                    <div class="form-group mb-0">
                                        <label class="form-label"
                                            for="exampleFormControlSelect1">{{ translate('Variant') }}<span
                                                class="input-label-secondary"></span></label>
                                        <select name="variant_type" id="variant_type"
                                            class="form-control h--45px js-select2-custom">
                                            <option value="" selected disabled>
                                                ---{{ translate('messages.Select Variant') }}---</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4 col-sm-6">
                                    ...
                                    <button id="add_item" type='button' class="btn btn--primary"
                                        style="margin-top: 30px">{{ translate('Add Item') }}</button>
                                </div>
                                        ...
                                        <div class="row pt-4">
                                            <div class="col-md-3 pt-3">
                                                <input type="text" class="form-control h--45px"
                                                    name="items[{{ $item['food_id'] }}][name][]"
                                                    value="{{ $item['name'] }}"
                                                    placeholder="{{ translate('messages.choice_title') }}" readonly>
                                                <input type="hidden" name="items[{{ $item['food_id'] }}][prods_ids][]"
                                                    value="{{ $item['id'] }}">
                                            </div>
                                            <?php
                                            $vars = [];
                                            $opts = \App\Models\DealOptions::where('deal_id', $deal['id'])
                                            ...
                                            <div class="col-md-6 pt-3">
                                                <input type="text" class="form-control h--45px"
                                                    value="{{ implode(',', $vars) }}"
                                                    name="items[{{ $item['food_id'] }}][options][][]"
                                                    placeholder="{{ translate('Add Choices') }}" data-role="tagsinput">
                                            </div>
                                            <div class="col-md-3 pt-3">
                                                <button type="button"
    ...
    function getRequest(route, id) {
        $.get({
            ...
            success: function(data) {
                ...
                $('#' + id).empty(); // Clear the select options
    ...
    <script>
        ...
        function add_product_in_deal(id, name, variant) {
            ...
            $('#added_products').append('<div class="row pt-4"><div class="col-md-3 pt-3"><input type="text" ' +
                ...
                '</div>' +
                '<div class="col-md-6 pt-3">' +
                '<input type="text" class="form-control h--45px" name="items[' + id +
                '][options][][]" placeholder="{{ translate('Add Choices') }}" data-role="tagsinput"></div>' +
                '<div class="col-md-3 pt-3">' +
        ...
        function add_more_customer_choice_option(i, name) {
            ...
            $('#customer_choice_options').append(
                '<div class="col-lg-6 attr--item-added"><div class="left"><input type="hidden" name="choice_no[]" value="' +
                i + '"><input type="text" class="form-control h--45px" name="choice[]" value="' + n +
                '" placeholder="{{ translate('messages.choice_title') }}" readonly></div><div class="right"><input type="text" class="form-control h--45px" name="choice_options_' +
                i +
...
<script>
    $('#food_form').on('submit', function(e) {
        ...
        $.ajax({
            url: '{{ route('deal-update-mobile', [$deal['id']]) }}',
            method: 'POST',
            data: formData,
            cache: false,
            contentType: false,
            ...
            success: function(data) {
                ...
                if (data.errors) {
                    ...
                    toastr.success('{{ translate('messages.Deal_updated_successfully') }}', {
                        CloseButton: true,
                        ProgressBar: true
                    });
                    setTimeout(function() {
                        location.href = '{{ route('success-mobile') }}';
                    }, 2000);
                }
            },
