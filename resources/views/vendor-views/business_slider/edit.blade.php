...
@section('content')
    <div class="content container-fluid">
        ...
        <div class="card">
            <div class="card-body">
                <form action="{{route('vendor.business_slider.update',[$businessSlider['id']])}}" method="post" id=campaign-form
...
@push('script_2')
    <script>
        ...
        $('#campaign-form').on('submit', function (e) {
            ...
            $.post({
                url: '{{route('vendor.business_slider.update',[$businessSlider['id']])}}',
                data: formData,
                cache: false,
                contentType: false,
                processData: false,
                success: function (data) {
                    if (data.errors) {
                        ...
                        setTimeout(function () {
                            location.href = '{{route('vendor.business_slider.list',)}}';
                        }, 2000);
                    }
                }
            });
