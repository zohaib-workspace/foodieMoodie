        ...
        <div class="page-header">
            <div class="row align-items-center">
                ...
                <div class="col-sm-auto">
                    <a class="btn btn--primary" href="{{route('vendor.business_slider.add-new')}}">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <label class="toggle-switch toggle-switch-sm" for="statusCheckbox{{$slider->id}}">
                                            <input type="checkbox" name="status" onclick="location.href='{{route('vendor.business_slider.status',[$slider['id'],$slider->status?0:1])}}'" class="toggle-switch-input" id="statusCheckbox{{$slider->id}}" {{$slider->status?'checked':''}}>
...
@push('script_2')
    ...
    <script>
        $('#search-form').on('submit', function (e) {
            ...
            $.post({
                url: '{{route('vendor.business_slider.search')}}',
                data: formData,
                cache: false,
                contentType: false,
                processData: false,
