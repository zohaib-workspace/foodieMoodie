                            ...
                            <div class="row gy-3 gx-2">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="name" class="form-label">{{translate('messages.business')}} {{translate('messages.name')}} <span class="text-danger">*</span></label>
                    ...
                    <div class="card h-100">
                        <div class="card-header">
                            <h5 class="card-title font-regular">
                                {{translate('Upload Business Logo')}} <span class="text-danger">({{translate('messages.Ratio 200x200')}})</span>
                            </h5>
                        </div>
