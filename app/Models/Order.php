...
class Order extends Model
{
    ...
    {
        return $this->hasOne(DMReview::class);
    }
    ...
    {
        return $this->hasMany(DealOrderDetail::class);
    }
    ...
    {
                return $query->whereNotIn('order_status', ['delivered','canceled','pending','refunded']);
    }
    ...
    public function scopeSearchingForDeliveryman($query)
    {
         ...
         return $query->whereNull('delivery_man_id')->where('order_type' , '!=','take_away');
    }
