...
class DeliverymanController extends Controller
{
    public function get_reviews($id){
        $reviews = DMReview::where('delivery_man_id',$id);
    ...
    public function get_profile(Request $request)
    {
        ...
        unset($dm['wallet']);
        return _response(1,translate('messages.success'),$dm,200);
    }
    ...
    public function get_current_orders(Request $request)
    {
        ...
        ->whereIn('order_status', ['accepted','confirmed','pending', 'processing', 'picked_up', 'handover','rider_accepted'])
    ...
    public function get_wallet_data(Request $request){
        try{
            ...
            return _response(0,"Failed to get data.",['message'=>$e]);
        }
