    ...
    public function login(Request $request)
    {
        ...
        if (auth('delivery_men')->attempt($data)) {
            ...
            if(auth('delivery_men')->user()->application_status != 'approved')
            {
                ...
                return _response(1,translate('messages.failed'),$errors,401);
            ...
            $delivery_man->save();
            return _response(1,translate('messages.Successfully_Logged_In'),['token' => $token, 'zone_wise_topic'=>$delivery_man->type=='zone_wise'?$delivery_man->zone->deliveryman_wise_topic:'restaurant_dm_'.$delivery_man->restaurant_id],200);
            ...
            return _response(1,translate('messages.failed'),['errors'=>$errors],401);
        }
    }
