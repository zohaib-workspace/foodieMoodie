    ...
    public function dashboard(Request $request)
    {
        ...
        for ($inc = 1; $inc <= 12; $inc++) {
         ...
         $food_id = Food::get('id');
             ...
             $total_quan = OrderDetail::whereIn('food_id', $food_id)->get();
            //  foreach($food_id as $key => $ss){
             
            //  print_r($ss['id']);
            //  }
            //  exit;
        // foreach($total_quan as $key => $qqq){
        //     $ccc = collect($qqq);
        //   print_r($ccc) ;
        // }
        
        // $sss =  OrderDetail::whereIn('food_id', $food_id)->sum('quantity');
        // $rrr =  collect($total_quan)->where('food_id','4')->sum('quantity');
        // print_r($sss);
        // print_r($rrr);
        // exit;
        ...
        // $id = 3;
        // $id2 = 4;
        // $new_data=Food::find($id);
        // $new_data2 =Food::find($id2);
        // $new_data->order_count = $sss;
        // $new_data2->order_count = $rrr;
        ...
        $id =  Helpers::get_restaurant_id();
           $orders = Order::where('order_status','pending')->orderBy('schedule_at', 'desc')->where('restaurant_id',$id)->get();
