...
Route::group(['namespace' => 'Admin', 'as' => 'admin.'], function () {
    ...
    Route::get('assign_order', 'OrderController@assign_order')->name('assign_order');
    ...
    Route::group(['middleware' => ['admin']], function () {
       ...
       Route::group(['prefix' => 'about', 'as' => 'about.'], function () {
         Route::get('about','AboutController@show')->name('show');
        });
        Route::group(['prefix' => 'about', 'as' => 'about.', 'middleware' => ['module:about']], function () {
            Route::get('list', 'AboutController@list')->name('list');
            Route::get('add-new', 'AboutController@create')->name('add-new');
            Route::post('store', 'AboutController@store')->name('store');
            Route::get('status/{id}/{status}', 'AboutController@status')->name('status');
            Route::get('edit/{about}', 'AboutController@edit')->name('edit');
            Route::delete('delete/{about}', 'AboutController@delete')->name('delete');
            Route::get('index', 'AboutController@index')->name('index');
            Route::post('search', 'AboutController@search')->name('search');
            Route::post('update/{about}', 'AboutController@update')->name('update');
        });
        Route::group(['prefix' => 'privacy_policy', 'as' => 'privacy_policy.'], function () {
        Route::get('privacy_policy','PrivacyPolicyController@show')->name('show');
        });
        Route::group(['prefix' => 'privacy_policy', 'as' => 'privacy_policy.', 'middleware' => ['module:privacy_policy']], function () {
            Route::get('list', 'PrivacyPolicyController@list')->name('list');
            Route::get('add-new', 'PrivacyPolicyController@create')->name('add-new');
            Route::post('store', 'PrivacyPolicyController@store')->name('store');
            Route::get('status/{id}/{status}', 'PrivacyPolicyController@status')->name('status');
            Route::get('edit/{privacy_policy}', 'PrivacyPolicyController@edit')->name('edit');
            Route::delete('delete/{privacy_policy}', 'PrivacyPolicyController@delete')->name('delete');
            Route::get('index', 'PrivacyPolicyController@index')->name('index');
            Route::post('search', 'PrivacyPolicyController@search')->name('search');
            Route::post('update/{privacy_policy}', 'PrivacyPolicyController@update')->name('update');
        });
        Route::group(['prefix' => 'terms_and_conditions', 'as' => 'terms_and_conditions.'], function () {
        Route::get('terms_and_conditions','TermsAndConditionController@show')->name('show');
        });
        Route::group(['prefix' => 'terms_and_conditions', 'as' => 'terms_and_conditions.', 'middleware' => ['module:terms_and_conditions']], function () {
            Route::get('list', 'TermsAndConditionController@list')->name('list');
            Route::get('add-new', 'TermsAndConditionController@create')->name('add-new');
            Route::post('store', 'TermsAndConditionController@store')->name('store');
            Route::get('status/{id}/{status}', 'TermsAndConditionController@status')->name('status');
            Route::get('edit/{terms_and_conditions}', 'TermsAndConditionController@edit')->name('edit');
            Route::delete('delete/{terms_and_conditions}', 'TermsAndConditionController@delete')->name('delete');
            Route::get('index', 'TermsAndConditionController@index')->name('index');
            Route::post('update/{id}', 'TermsAndConditionController@update')->name('update');
        });
        ...
        Route::group(['prefix' => 'business_slider', 'as' => 'business_slider.', 'middleware' => ['module:business_slider']], function () {
            ...
            Route::post('update/{businessSlider}', 'BusinessSliderController@update')->name('update');
        });

        Route::group(['prefix' => 'query', 'as' => 'query.', 'middleware' => ['module:query']], function () {
            Route::get('/', 'querycontroller@index')->name('home');
            Route::post('store', 'querycontroller@store')->name('store');
            Route::get('edit/{id}', 'querycontroller@edit')->name('edit');
            Route::post('update/{id}', 'querycontroller@update')->name('update');
            Route::delete('delete/{query}', 'querycontroller@destroy')->name('delete');
            Route::get('status/{id}/{status}', 'querycontroller@status')->name('status');

            Route::get('add_sub', 'querycontroller@add_sub')->name('add_sub');
            Route::post('sub_store', 'querycontroller@sub_store')->name('sub_store');
            Route::get('sub_edit/{id}', 'querycontroller@sub_edit')->name('sub_edit');
            Route::post('sub_update/{id}', 'querycontroller@sub_update')->name('sub_update');


            Route::post('search', 'querycontroller@search')->name('search');
            Route::get('query-filter/{id}', 'querycontroller@country_filter')->name('queryfilter');
        });


 Route::group(['prefix' => 'userquires', 'as' => 'userquires.', 'middleware' => ['module:userquires']], function () {
            Route::get('list', 'userquiresController@list')->name('list');
            Route::post('admin-response/{id}', 'userquiresController@admin_resp_to_order_report')->name('admin-response');
            Route::get('rider_list', 'userquiresController@rider_list')->name('rider_list');
            Route::post('admin-response-rider/{id}', 'userquiresController@admin_resp_to_rider_query')->name('admin-response-rider');
        });
        ...
        Route::group(['prefix' => 'report', 'as' => 'report.', 'middleware' => ['module:order']], function () {
            Route::get('order-reports-index', 'OrderReportController@order_reports_index')->name('order-reports-index');
            Route::post('admin-response/{id}', 'OrderReportController@admin_resp_to_order_report')->name('admin-response');
        });
        ...
        Route::group(['prefix' => 'zone', 'as' => 'zone.', 'middleware' => ['module:zone']], function () {
          ...
          Route::group(['prefix' => 'country', 'as' => 'country.', 'middleware' => ['module:country']], function () {
            ...
            Route::post('update/{id}', 'CountryController@update')->name('update');
            Route::delete('delete/{country}', 'CountryController@destroy')->name('delete');
            Route::get('status/{id}/{status}', 'CountryController@status')->name('status');
            Route::post('search', 'CountryController@search')->name('search');
            Route::get('country-filter/{id}', 'CountryController@country_filter')->name('countryfilter');
        });
        ...
        Route::group(['prefix' => 'city', 'as' => 'city.', 'middleware' => ['module:city']], function () {
            ...
            Route::delete('delete/{city}', 'CityController@destroy')->name('delete');
            Route::get('status/{id}/{status}', 'CityController@status')->name('status');
            Route::post('search', 'CityController@search')->name('search');
            Route::get('city-filter/{id}', 'CityController@country_filter')->name('cityfilter');
        });
        ...
        Route::group(['prefix' => 'business-settings', 'as' => 'business-settings.', 'middleware' => ['module:settings']], function () {
            ...
            Route::get('timezone-add','BusinessSettingsController@timezone_index')->name('timezone-add');
            Route::post('timezone-add', 'BusinessSettingsController@timezone_store');
            Route::get('timezone-update/{id}', 'BusinessSettingsController@timezone_edit')->name('timezone-update');
            Route::put('timezone-update/{id}', 'BusinessSettingsController@timezone_update');
            Route::delete('timezone-deletet/{id}', 'BusinessSettingsController@timezone_delete')->name('timezone-delete');
            Route::post('search', 'BusinessSettingsController@timezone_search')->name('search');

            // HAA-25_03_2023-timezone-end
            
            // HAA-27_03_2023-service-start

            Route::get('services-add','BusinessSettingsController@services_index')->name('services-add');
            Route::post('services-add', 'BusinessSettingsController@service_store');
            Route::get('service-update/{id}', 'BusinessSettingsController@service_edit')->name('service-update');
            Route::put('service-update/{id}', 'BusinessSettingsController@service_update');
            Route::delete('service-deletet/{id}', 'BusinessSettingsController@service_delete')->name('service-delete');
            Route::get('status/{id}/{status}', 'BusinessSettingsController@status')->name('status');
            Route::post('service-search', 'BusinessSettingsController@service_search')->name('service-search');


            // HAA-27_03_2023-service-end
            
            //absher Express
            Route::get('absher-express','ExpressController@express_index')->name('absher-express');
            Route::get('express-update/{id}', 'ExpressController@express_edit')->name('express-update');
            Route::put('express-update/{id}', 'ExpressController@express_update');
        ...
        Route::group(['prefix' => 'delivery-man', 'as' => 'delivery-man.'], function () {
            ...
            Route::group(['middleware' => ['module:deliveryman']], function () {
                ...
                Route::get('shifts','DeliveryManController@shifts_index')->name('shifts');
                Route::post('shift-add', 'DeliveryManController@shift_store')->name('shift-add');
                Route::get('shift-update/{id}', 'DeliveryManController@shift_edit')->name('shift-update');
                Route::put('shift-update/{id}', 'DeliveryManController@shift_update');
                Route::delete('shift-deletet/{id}', 'DeliveryManController@shift_delete')->name('shift-delete');
                Route::get('status/{id}', 'DeliveryManController@shiftStatus')->name('status');
                Route::post('shift-search', 'DeliveryManController@shift_search')->name('shift-search');
